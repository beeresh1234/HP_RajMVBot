...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        try:
            ...
            if btn:
                ...
                await query.answer(
                    ...
                    "‼️ ᴊᴏɪɴ ᴀʟʟ ᴍʏ ʙᴇʟᴏᴡ ᴄʜᴀɴɴᴇʟs ᴀɴᴅ ᴄʟɪᴄᴋ ᴛʀʏ ᴀɢᴀɪɴ.‼️\n\n"
                    "‼️ಕೆಳಗಿನ ನನ್ನ ಎಲ್ಲಾ ಚಾನೆಲ್ಗಳಿಗೆ ಜಾಯಿನ್ ಆಗಿ ಮತ್ತು ᴛʀʏ ᴀɢᴀɪɴ ಕ್ಲಿಕ್ ಮಾಡಿ. ‼️\n",
                    show_alert=True
                )
                return
        ...
        buttons = [[
            InlineKeyboardButton('⚡ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴩ ⚡', callback_data='disclaimer'),
            InlineKeyboardButton ('〽️ ꜱᴜᴩᴩᴏʀᴛ ᴄʜᴀᴛ 〽️', callback_data='source'),
        ],[
            InlineKeyboardButton('💢 ʙᴀᴄᴋᴜᴩ 💢', callback_data='donation'), 
        ],[
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ᴛᴏ ʜᴏᴍᴇ ⇋', callback_data='start')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
